        ...
        <>
            {
                ...
                :
                <iframe class="media_display" title="videoPlayer2" src={"https://player.twitch.tv/?channel=" + twitchStreamers[currentStreamer] + "&parent=https://merryface.github.io/niwi-website/"} frameborder="0" allowfullscreen="true" />
            }
        </>
    )
}

        ...
        <>
            {
                ...
                :
                <iframe class="media_display" title="videoPlayer2" src={"https://player.twitch.tv/?channel=" + twitchStreamers[currentStreamer] + "&parent=secretasteroidbase.com"} frameborder="0" allowfullscreen="true" />
            }
        </>
    )
}

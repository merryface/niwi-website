    ...
    return (
        <section className="hero">
            ...
            <div className="videoContainer">
                <iframe title="niwi trailer" className="videoContainer__video" width="x" height="y" src="https://www.youtube.com/embed/ipxu81WiQsw?controls=0&amp;start=57?autoplay=1&mute=1" autoplay="1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;"></iframe>
            </div>
